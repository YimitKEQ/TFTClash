          ...
          <div className="bg-surface-container-low relative overflow-hidden shadow-[0_40px_40px_rgba(0,0,0,0.4)]">
            ...
            <div className="p-10 space-y-8">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs font-condensed uppercase tracking-widest text-on-surface/40">Sign in with your Discord account</p>
              </div>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <span className="font-condensed text-sm font-bold uppercase tracking-widest text-white">Sign in with Discord</span>
                </button>

                <p className="text-center text-xs font-condensed text-on-surface/30 leading-relaxed">
                  We use Discord for secure authentication.<br />
                  No passwords to remember, no emails to verify.
                </p>
              </div>
            </div>
