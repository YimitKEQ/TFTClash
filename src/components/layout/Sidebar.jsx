  ...
  function NavItem(props) {
    ...
    return (
      <button
        ...
        className={'flex items-center gap-4 px-6 py-3.5 w-full text-left border-none cursor-pointer transition-all duration-200 font-["Barlow_Condensed"] uppercase text-xs font-semibold tracking-widest relative ' +
          (isActive
  ...
  return (
    <aside className="hidden xl:flex fixed left-0 top-0 h-screen w-64 bg-[#13131A] border-r border-white/[0.05] flex-col z-40 pt-20">
      ...
      <div className="px-6 py-6 border-b border-white/[0.05]">
        <div className="font-['Russo_One'] text-primary text-base uppercase tracking-tight">TFT Clash</div>
        <div className="font-['Barlow_Condensed'] uppercase text-[10px] font-semibold text-on-surface/30 tracking-widest mt-0.5">Elite Competition</div>
      </div>
      ...
      <div className="px-5 py-5 border-t border-white/[0.05] shrink-0">
        <button
          ...
          className="w-full py-3 rounded-full bg-gradient-to-br from-primary to-[#CC8A28] text-[#07070E] font-['Barlow_Condensed'] font-bold uppercase tracking-widest text-sm cursor-pointer border-none active:scale-95 transition-transform shadow-[0_4px_20px_rgba(232,168,56,0.3)]"
        >
