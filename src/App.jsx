    ...
    <div className="page wrap">
      ...
      {checkedIn.length>0&&(
        ...
        <>
          ...
          {tournamentState&&tournamentState.phase==="inprogress"&&lockedLobbies.length>0&&LiveStandingsPanel({checkedIn,tournamentState,lobbies,round})}
