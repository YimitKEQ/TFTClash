...
// ─── DISCORD ─────────────────────────────────────────────────────────────────
export var DISCORD_URL = "https://discord.gg/2wM3AgYAPr";
...
export var TIER_FEATURES = {
  free: {
    ...
    currentSeasonHistory: true, joinScrimRoom: true,
    enhancedStats: false, proBadge: false, priorityRegistration: false,
    extendedHistory: false, customBanner: false, comparisonTool: false,
    emailDigest: false, discordRole: false,
  ...
  pro: {
    compete: true, basicStats: true, basicProfile: true, viewResults: true,
    currentSeasonHistory: true, joinScrimRoom: true,
    enhancedStats: true, proBadge: true, priorityRegistration: true,
    extendedHistory: true, customBanner: true, comparisonTool: true,
    emailDigest: true, discordRole: true,
    createScrimRoom: false, multiLobbySeeding: false, scrimStats: false,
    scrimTournaments: false, scrimSeasons: false, roomCustomization: false,
    createTournaments: false, brandedPages: false, hostDashboard: false,
    customRules: false, apiAccess: false, entryFees: false, verifiedHost: false,
