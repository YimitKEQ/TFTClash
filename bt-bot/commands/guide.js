...
var TOPICS = [
  ...
  },
  {
    ...
    color: COLOR.live,
    summary: 'The headline feature. Two commands in, a written recap and real tasks out. Audio is transcribed on the machine the bot runs on and deleted straight after.',
    steps: [
      ...
      '**Run `/record stop`.** Add `title:Weekly sync` if you want to name it. Transcription is CPU bound, so a long call takes a couple of minutes.',
    ...
    notes: [
      ...
      'Audio and intermediate files are written to a temp directory and deleted after transcription. Only the text is kept.',
